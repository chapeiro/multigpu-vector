...
int main(){
    ...
    Operator * oprod2 = omat;//cuda_new<Operator>(1, exc2->prods[0]);

    vector<int>         prod_loc        = {-1};
    vector<int>         prodout_loc     = {-1};
    vector<int>         prodout_size    = {1024};
    vector<int>         prod2out        = {0};
    vector<Operator *>  parents         = {oprod2};
    vector<dim3>        parent_dimGrid  = {dim3(1)};
    vector<dim3>        parent_dimBlock = {dim3(1)};
